...
const InventoryInwardListComponent = () => {
  // JSX
  return (
    <React.Fragment>
      ...
      <div className="h-full flex-1 flex-col space-y-8 md:flex">
        <div className="flex items-center justify-between space-y-2">
          <div>
            <h2 className="text-3xl font-bold tracking-tight">Inward</h2>
          ...
          <div className="flex items-center space-x-2">
            ...
            <Button asChild variant="blue" >
              <Link to={fullRoute.aGlobalRoute.bProtectedRoute.bAuthorizationRoute.bSidebarRoute.cInvenTechRoute.aOverallRoute.lInventoryInwardRoute.bCreateRoute} ><PlusIcon /> Create</Link>
            </Button>
            <Button asChild variant="blue" >
...
export default InventoryInwardListComponent;
