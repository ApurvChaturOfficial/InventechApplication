...
const LocationRetrieveComponent = () => {
  // Destructure Props
  ...
  return (
    <React.Fragment>
      {/* LocationRetrieveComponent */}
      <div className="flex-1 space-y-8">
        <div className="flex items-center justify-between space-y-2">
          <div>
            <h2 className="text-3xl font-bold tracking-tight">Loaction Information
            </h2>
...
export default LocationRetrieveComponent;
