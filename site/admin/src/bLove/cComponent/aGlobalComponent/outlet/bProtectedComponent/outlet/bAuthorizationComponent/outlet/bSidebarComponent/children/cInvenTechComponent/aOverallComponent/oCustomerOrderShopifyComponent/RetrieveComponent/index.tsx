...
import { CheckCircle, OctagonMinus, RefreshCwIcon, Trash2Icon } from "lucide-react";
import { Link } from "react-router-dom";
import SampleMiniListComponent from "./component/aSampleMiniListComponent";
import data from "./extras/bData";


// type CustomerOrderShopifyRetrieveComponentType = {
  // ReduxCall: any
  // APICall: {
...
const CustomerOrderShopifyRetrieveComponent = () => {
  // Destructure Props
  ...
  return (
    <React.Fragment>
      {/* CustomerOrderShopifyRetrieveComponent */}
                        ...
                        <ul className="grid gap-3 grid-cols-5">
                          {eachSection.values.map((eachValue: any, indexValue: number) => (
                            <React.Fragment>
                              ...
                              {((eachValue.type === "normal-green" &&
                                <li className={cn("flex flex-col gap-1 items-start justify-between text-green-400", eachValue?.style)} key={indexValue} >
                                  <span className="text-muted-foreground">
                                    {eachValue.label}:
                                  </span>
                                  <span className="w-4/5 truncate text-lg" >{eachValue.value || "--N/A--"}</span>
...
export default CustomerOrderShopifyRetrieveComponent;
